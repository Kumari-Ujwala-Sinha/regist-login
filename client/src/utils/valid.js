const valid=({ email, password, firstname, username, cf_password})=>{
    const err={}
    if(!firstname){
        err.firstname="Please Enter your Full Name"
    }else if(firstname.length>25){
        err.firstname=" Full Name must be less than 25 characters"
    }
    if(!username){
